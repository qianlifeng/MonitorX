                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="pull-right">
                                    <i class="fa forewarning-icon clickable" v-on:click="editMetricForewarning(metric)" data-toggle="tooltip" data-placement="top" title="When {{notifier.forewarningTitle}}, notify {{notifier.title}}" v-bind:class="{'fa-link':notifier.type == 'callback','fa-wechat':notifier.type == 'wechat','fa-envelope-o':notifier.type=='email'}" v-for="notifier in getMetricNotifers(metric)"></i>
