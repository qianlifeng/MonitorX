    ...
    <div class="notifier">
        <div class="row">
            ...
            <div class="col-sm-3 add-new">
                <a href="javascript:;" class="dropdown-toggle pull-right" @click="showCreateNotifierDialog = true" data-toggle="tooltip"
                    data-placement="top" title="Add notifier"><span class="fa fa-plus"></span></a>
            </div>
        </div>
